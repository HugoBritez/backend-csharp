...
var VentaAdapter = /** @class */ (function () {
    function VentaAdapter() {
    }
    VentaAdapter.adaptarVentaDTO = function (ventaDTO) {
        // Formatear la fecha al formato YYYY-MM-DD
        var fecha = new Date(ventaDTO.ve_fecha);
    ...
    VentaAdapter.adaptarDetalleVentaDTO = function (detalleDTO) {
        return {
