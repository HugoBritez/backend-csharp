...
const { cotizacionDelDia } = require("../../finanzas/cotizaciones/utils/getCotizacionDelDia");

const { VentaAdapter } = require("./venta.adapter");

const { guardarAsientoAutomatico } = require("../../contabilidad/services/guardarAsiento");
const { guardarAsientoCosto } = require("../../contabilidad/services/guardarCostoAsiento");
...
`;
  ...
  async function agregarVentaDesdeDTO(req, res) {
    try {
      ...
      const resultado = await agregarVentaNuevo(ventaAdaptada, detallesAdaptados);
