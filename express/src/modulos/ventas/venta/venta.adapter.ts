...
import { 
    ...
    DetalleVentaDTO, 
    VentaAdaptada, 
    DetalleVentaAdaptado 
} from './interfaces/shared.type';

export class VentaAdapter {
    static adaptarVentaDTO(ventaDTO: VentaDTO): VentaAdaptada {
    ...
    static adaptarDetalleVentaDTO(detalleDTO: DetalleVentaDTO): DetalleVentaAdaptado {
        return {
