...
module.exports = function (dbInyectada) {
    ...
    function resumenRepartos(fecha_desde, fecha_hasta, sucursales, choferes, camiones, tipos, id_entrega) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (id_entrega) {
                ...
                if (tipos && tipos.length > 0) {
                    ...
                    if (tipos.includes("2")) {
                        condiciones.push("(r.r_hora_s IS NOT NULL AND r.r_hora_s != '' AND (r.r_hora_l IS NULL OR r.r_hora_l = ''))");
                    }
                    if (tipos.includes("3")) {
                        condiciones.push("(r.r_hora_s IS NOT NULL AND r.r_hora_s != '' AND r.r_hora_l IS NOT NULL AND r.r_hora_l != '')");
                    }
                    if (tipos.includes("4")) {
        ...
        JSON_OBJECT(
          ...
          'cliente', (
            ...
            CASE
              ...
              WHEN drc.d_cliente IS NOT NULL THEN cli_ped.cli_razon  
  ...
  `;
    ...
    function insertarReparto(datos) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        `;
                const resultRuteo = yield db.sql(queryRuteo);
            ...
            `;
                    const resultDetalle = yield db.sql(queryDetalleRuteo);
    ...
    function listarRutas(query) {
      ...
      ${whereVendedor}
    `;
            const result = yield db.sql(querySql);
            return result;
        });
    }
    function listarReparto(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
      SELECT 
          dr.d_codigo as id,
    ...
    function listarDetalleReparto(query) {
        return __awaiter(this, void 0, void 0, function* () {
        ...
        `;
            ...
            const result = yield db.sql(sqlQuery);
            return result;
        });
    }
    function marcarSalidaRuta(query) {
        return __awaiter(this, void 0, void 0, function* () {
            const id = query.id;
            const km = query.km;
            const querySql = `
    ...
    function marcarLlegadaRuta(query) {
        return __awaiter(this, void 0, void 0, function* () {
            const id = query.id;
            const km = query.km;
            const querySql = `
    ...
    // Función auxiliar para enviar mensajes de Telegram de forma asíncrona
    function enviarMensajeTelegramAsync(chatId, mensaje, latitud, longitud) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log(`[${new Date().toISOString()}] Iniciando envío de mensaje a ${chatId}`);
                yield telegramBot.enviarMensajeConUbicacion(chatId, mensaje, latitud, longitud);
                console.log(`[${new Date().toISOString()}] Mensaje enviado exitosamente a ${chatId}`);
            }
            catch (error) {
                console.error(`[${new Date().toISOString()}] Error enviando mensaje a ${chatId}:`, error);
            }
        });
    }
    function marcarLlegadaEntrega(id, chat_id, latitud, longitud) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    `;
                const infoResult = yield db.sql(queryInfo);
    ...
    `;
                ...
                const mensaje = `🚚 <b>Llegada a Cliente</b>\n\n👨‍✈️ Chofer: ${info.chofer}\n👥 Cliente: ${info.cliente}\n🕒 Hora: ${horaLocal}`;
                const chatIds = Array.isArray(chat_id) ? chat_id : [chat_id];
                // Enviamos la respuesta inmediatamente
                const response = {
                    success: true,
                    mensaje: "Llegada registrada, notificación en proceso"
                };
                // Enviamos los mensajes de Telegram de forma asíncrona
                chatIds.forEach(chatId => {
                    enviarMensajeTelegramAsync(chatId, mensaje, latitud, longitud);
    ...
    function marcarSalidaEntrega(id, chat_id, latitud, longitud) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const queryInfo = `
        SELECT 
        ...
        `;
                ...
                const response = {
                    success: true,
                    mensaje: "Salida registrada, notificación en proceso"
                };
                // Enviamos los mensajes de Telegram de forma asíncrona
                chatIds.forEach(chatId => {
                    enviarMensajeTelegramAsync(chatId, mensaje, latitud, longitud);
    ...
    function fetchDetalleVentas(id_venta) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
      SELECT
    ...
    function fetchDetallePedidos(id_pedido) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
      SELECT
      dp_articulo as item,
