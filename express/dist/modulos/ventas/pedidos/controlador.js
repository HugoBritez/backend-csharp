...
module.exports = function (dbInyectada) {
    ...
    function getPedidosNuevo(fecha_desde, fecha_hasta, nro_pedido, articulo, clientes, vendedores, sucursales, estado, //1- pendiente, 2- procesado, 3- todos
    moneda, factura) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (nro_pedido) {
                ...
                if (estado === '1')
                    where += ` AND p.p_estado = 1`;
                if (estado === '2')
                    where += ` AND p.p_estado = 2`;
                if (estado === '3')
                    where += ` AND (p.p_estado = 1 OR p.p_estado = 2)`;
            }
            let query = `
      SELECT
    ...
    function getCabeceras(fecha_desde, fecha_hasta, sucursal, cliente, vendedor, articulo, moneda, factura, limit) {
        let where = "1 = 1";
        if (fecha_desde)
            where += ` AND p.p_fecha >= '${fecha_desde}'`;
        if (fecha_hasta)
    ...
    function autorizar(pedido, user_name, username, password) {
        return __awaiter(this, void 0, void 0, function* () {
            const loginResult = yield require("../../usuarios/controlador.js")().login(username, password);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const tabla_query = `SELECT
                        ...
                        FROM
                          ...
                          (SELECT @can := 0) r
                        WHERE pe_pedido = ${id}`;
            let tabla = yield db.sql(tabla_query);
    ...
    function agregarPedido(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const pedidoResult = yield db.agregar(CABECERA, {
    ...
    function actualizarPedidoParcial(pedidoId, itemsEliminados) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log("Iniciando la actualización parcial del pedido", itemsEliminados);
                const detallesActuales = yield getDetalles(pedidoId);
                console.log("Detalles actuales del pedido", detallesActuales);
                for (const detalleActual of detallesActuales) {
                    const itemEliminado = itemsEliminados.find((item) => item.art_codigo === detalleActual.art_codigo);
                    if (itemEliminado) {
                        const cantidadActual = parseFloat(detalleActual.cantidad);
                        const cantidadEliminada = parseFloat(itemEliminado.cantidad);
                        console.log("comparando cantidades entre los items eliminados y los detalles actuales", cantidadActual, cantidadEliminada);
                        if (cantidadActual !== cantidadEliminada) {
                            const nuevaCantidad = cantidadActual - cantidadEliminada;
                            console.log("nueva cantidad", nuevaCantidad);
                            yield db.actualizar(DETALLES, { dp_cantidad: nuevaCantidad }, detalleActual.det_codigo, "dp_codigo");
                            console.log("Cantidad actualizada para el item", detalleActual.det_codigo);
                        }
                        else {
                            console.log("las cantidades son iguales, no se actualiza la cantidad");
                        }
                    }
                }
                for (const detalle of detallesActuales) {
                    const itemNoEliminar = itemsEliminados.find((item) => item.art_codigo === detalle.art_codigo);
                    if (!itemNoEliminar) {
                        console.log("eliminando el detalle de la venta completamente vendida", detalle.art_codigo);
                        yield db.actualizar(DETALLES, { dp_cantidad: 0 }, detalle.det_codigo, "dp_codigo");
                    }
                    else {
                        console.log("No se elimina el detalle", detalle.art_codigo);
                    }
                }
                const detallesFinales = yield getDetalles(pedidoId);
                console.log("Detalles finales del pedido", detallesFinales);
                const todosCero = detallesFinales.every((detalle) => parseFloat(detalle.cantidad) === 0);
                if (todosCero) {
                    console.log("Todos los detalles del pedido están en 0, se procede a eliminar el pedido");
                    yield db.actualizar(CABECERA, { p_tipo_estado: 2 }, pedidoId, "p_codigo");
    ...
    function updateObservacionPedido(pedidoId, observacion) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `UPDATE pedidos SET p_obs = '${observacion}' WHERE p_codigo = ${pedidoId}`;
            return db.sql(query);
        });
    }
    function prepararPedido(pedidoId, consolidar, cliente, fecha_desde, fecha_hasta, estado) {
        return __awaiter(this, void 0, void 0, function* () {
            let where = "1 = 1";
            if (consolidar === '1') {
    ...
    function iniciarPreparacionPedido(pedidoIds, preparadoPor) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    function traerPedidosAPreparar(deposito_id) {
        return __awaiter(this, void 0, void 0, function* () {
            let where = '';
            if (deposito_id) {
    ...
    function traerItemsPorPedido(pedidoId, buscar) {
        return __awaiter(this, void 0, void 0, function* () {
            let where = '';
            if (buscar) {
    ...
    function cargarPedidoPreparado(pedidoId, cantidad) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
    ...
    function insertarCantidadDeCajas(pedidoId, cantidad, verificadoPor) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
        UPDATE
          pedidos
    ...
    function obtenerPedidosParaVenta(pedidoId) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
      SELECT
        p.p_codigo as id,
    ...
    function reportePreparacionPedidos(fecha_desde, fecha_hasta) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
    SELECT
      p.p_codigo as id_pedido,
    ...
    const getPedidosParaAgenda = (vendedor, cliente, busqueda) => __awaiter(this, void 0, void 0, function* () {
        let where = "";
        if (busqueda) {
    ...
    function getPedidosFaltantes(filtros) {
        return __awaiter(this, void 0, void 0, function* () {
            let where = '';
    ...
    function insertarDetalleFaltante(datos) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(datos);
            const query = `
    ...
    function rehacerPedidoConFaltantes(_a) {
        return __awaiter(this, arguments, void 0, function* ({ pedido_id, detalles = [] }) {
            try {
      ...
      `;
                ...
                const faltantes = yield db.sql(queryFaltantes);
      ...
      `;
                const pedidoOriginal = yield db.sql(queryPedido);
      ...
      `;
                const resultadoPedido = yield db.sql(insertPedido);
      ...
      `;
                const lotes = yield db.sql(queryLotes);
