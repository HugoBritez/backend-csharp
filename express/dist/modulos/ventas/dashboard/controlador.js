...
module.exports = function (dbInyectada) {
    ...
    function comprasPorMes(desde, hasta) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `SELECT
    ...
    function cobrosPorMes(desde, hasta) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `SELECT
                      mes,
    ...
    function pagosPorMes(desde, hasta) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `SELECT
                      mes,
    ...
    function presupuestos(desde, hasta) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `SELECT
    ...
    function presTabla(desde, hasta) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `SELECT
                    pre_operador,
                    op_nombre,
