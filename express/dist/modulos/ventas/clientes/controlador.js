...
module.exports = function (dbInyectada) {
    ...
    function ultimos(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ult_compra_array = yield db.sql(ult_compra_query);
            if (ult_compra_array.length > 0)
                ult_compra = ult_compra_array[0].ve_fecha;
            ...
            const ult_pago_array = yield db.sql(ult_pago_query);
