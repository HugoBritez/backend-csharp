...
function obtenerTimbrado(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const item = yield controlador.obtenerTimbrado(req.query.usuario);
...
function actualizarUltFactura(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const item = yield controlador.actualizarUltFactura(req.query.secuencia, req.query.codigo);
            respuesta.success(req, res, item, 200);
        }
        catch (err) {
            /*respuesta.error(req, res, err, 500)*/
...
function buscar(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const item = yield controlador.buscar(req.query.timb, req.query.fact);
            respuesta.success(req, res, item, 200);
        }
        catch (err) {
            /*respuesta.error(req, res, err, 500)*/
