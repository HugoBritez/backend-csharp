...
const TABLA_SUC = "definicion_ventas dv LEFT JOIN sucursales su ON dv.d_sucursal = su.id LEFT JOIN tipo_comprobante tc ON dv.d_comprobante = tc.t_codigo";
...
module.exports = function (dbInyectada) {
    ...
    function obtenerTimbrado(usuario) {
    ...
    function actualizarUltFactura(numero, codigo) {
        return __awaiter(this, void 0, void 0, function* () {
