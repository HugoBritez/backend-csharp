...
module.exports = function (dbInyectada) {
    ...
    function crear_inventario(inventario) {
    ...
    function get_inventario(inventario_id, nro_inventario, deposito, sucursal) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let where = "WHERE 1=1";
         ...
         ${where}
         ORDER BY ia.fecha DESC${!esConsultaEspecifica && (deposito || sucursal) ? " LIMIT 1" : ""}`;
                console.log(query);
    ...
    function get_inventarios(estado, deposito, sucursal, nro_inventario) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let where = "WHERE 1=1";
                if (estado !== undefined) {
    ...
    function insertar_items_inventario(inventario_id, deposito, filtros) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const inventarioExiste = yield db.sql(`
        SELECT id, estado 
      ...
      `);
        ...
        WHERE ${condiciones}
      `;
                const conteoResultado = yield db.sql(conteoQuery);
    ...
    const scannear_item_inventario = (id_articulo_1, id_lote_1, cantidad_1, ...args_1) => __awaiter(this, [id_articulo_1, id_lote_1, cantidad_1, ...args_1], void 0, function* (id_articulo, id_lote, cantidad, lote = "", talle_id, color_id, vencimiento, codigo_barras = "", id_inventario, ubicacion_id, sub_ubicacion_id) {
        try {
            ...
            const inventarioResult = yield db.sql(`
        ...
        `);
            ...
            const cantidadSQL = cantidad !== undefined && cantidad !== null ? cantidad : "NULL";
            const resultadoUpdate = yield db.sql(`
        ...
        `);
            ...
            return {
                ...
                codigo_barras_actualizado: codigo_barras && codigo_barras.trim().length > 0,
    ...
    function autorizar_inventario(id, operador, sucursal, deposito, nro_inventario) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
      ...
      `;
                ...
                yield db.sql(autorizarInventarioQuery);
                // Confirmar transacción
                yield db.sql("COMMIT");
                return {
                    error: false,
    ...
    const get_items_a_escanear = (nro_inventario, id_inventario, busqueda, deposito) => __awaiter(this, void 0, void 0, function* () {
        let where = "";
        if (busqueda) {
    ...
    const get_items_inventario = (nro_inventario_1, ...args_1) => __awaiter(this, [nro_inventario_1, ...args_1], void 0, function* (nro_inventario, // Número de inventario (no es la PK)
    scanneado = false, deposito, sucursal, buscar, id_inventario // ID del inventario (PK)
    ) {
       ...
       `;
        try {
            ...
            return resultado.map((inv) => {
                ...
                const porcentajeCompletado = inv.total_items > 0
                    ? Math.round((inv.items_escaneados / inv.total_items) * 100)
                    : 0;
                return Object.assign(Object.assign({}, inv), { porcentaje_completado: porcentajeCompletado, estado_texto: inv.estado === 0
                        ? "Abierto"
                        : inv.autorizado === 1
                            ? "Autorizado"
                            : "Cerrado" });
    ...
    function reporte_inventario() {
        return __awaiter(this, arguments, void 0, function* (id_inventario = null, categorias = [], incluir_sin_cambios = false, fecha_inicio = null, fecha_fin = null, deposito = null) {
            try {
                // Construir condiciones de filtro
                let filtros = [];
    ...
    `;
                ...
                const resultados = yield db.sql(query);
                // Agregar estadísticas adicionales
                if (resultados.length > 0) {
                    // Calcular totales
                    const totalItems = resultados.length;
                    const totalValorDiferencia = resultados.reduce((sum, item) => sum + parseFloat(item.valor_diferencia_numero || 0), 0);
                    const totalGanancias = resultados.filter((item) => item.tipo_diferencia === "GANANCIA").length;
                    const totalPerdidas = resultados.filter((item) => item.tipo_diferencia === "PERDIDA").length;
                    const valorGanancias = resultados
                        .filter((item) => item.tipo_diferencia === "GANANCIA")
                        .reduce((sum, item) => sum + parseFloat(item.valor_diferencia_numero || 0), 0);
    ...
    function actualizar_cantidad_inicial(id_inventario, id_articulo, id_lote, cantidad) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    `;
                ...
                const resultado = yield db.sql(updateQuery);
